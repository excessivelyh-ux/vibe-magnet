      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {packages.map((pkg, i) => (
          ...
          >
            ...
            <div className="text-muted-foreground text-sm mb-4">{t("followers")}</div>
  ...
  return (
    <section id="pricing" className="py-20 relative">
      ...
      <div className="container relative z-10">
        ...
        >
          <h2 className="font-heading text-3xl sm:text-4xl font-bold mb-4">{t("pricingTitle")}</h2>
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">{t("pricingDesc")}</p>
        </motion.div>
